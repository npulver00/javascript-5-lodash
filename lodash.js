...
const purchasesByMonth = _.groupBy(purchases, e => e.month); // Use groupBy to group the purchases by the month that they were made.

// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, function(accum, value, key){
